...
public class MatrixMultiplierTest {
	...
	public void test() {
		...
		Assert.assertArrayEquals(C[0], new double[]{15.0, 18.0, 14.0, 11.0}, .00005);
		Assert.assertArrayEquals(C[1], new double[]{31.0, 40.0, 26.0, 24.0}, .00005);
		Assert.assertArrayEquals(C[2], new double[]{16.0, 15.0, 15.0, 9.0}, .00005);
		Assert.assertArrayEquals(C[3], new double[]{53.0, 63.0, 47.0, 38.0}, .00005);
	}
